...
import 'package:linkify/view/error_screens/internetError.dart';
import 'package:linkify/view/home/bottom_nav_bar.dart';
import 'package:linkify/view/authorization_screen/webview_widget.dart';
    ...
    controller = WebViewController()
      ...
      ..setNavigationDelegate(NavigationDelegate(
        ...
        onWebResourceError: (WebResourceError error) {
          ...
          Navigator.of(context).push(MaterialPageRoute(builder: (context)=>const InternetErrorScreen()));
        },
