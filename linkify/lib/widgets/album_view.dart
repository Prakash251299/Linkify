...
class AlbumView extends StatefulWidget {
  var name,id,imgUrl;
  AlbumView(this.name,this.id,this.imgUrl);
        ...
        child: SafeArea(
          child: Stack(alignment: Alignment.topCenter, children: [
            ...
            Container(
              // color: Colors.red,
              padding:
                  EdgeInsets.only(top: 300 - _counter < 70 ? 57 : 300 - _counter-13),
                          ...
                          InkWell(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Row(children: [
                                Column(children: [
                                  Text("Kya haal hai",style:TextStyle(color: Colors.white70)),
                                ]),
                              ]),
                              isThreeLine: true,
                              trailing:  Column(
